    ...
    <div className="flex w-full items-start justify-center">
      <div className="flex flex-1 flex-col items-start justify-start gap-6 px-4 py-16 md:px-12 md:py-20 lg:flex-row lg:gap-12">
        ...
        <div className="flex w-full flex-col items-start justify-center gap-4 lg:flex-1 lg:py-5">
          <div className="font-mont text-muted-foreground flex w-full flex-col justify-center text-4xl leading-tight font-semibold tracking-tight md:leading-[44px]">
            ...
            {faqData.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="font-mont text-muted-foreground flex-1 text-base leading-6 font-medium">
                      {item.question}
                    </div>
