        ...
        <div className="flex flex-1 flex-col items-end justify-center gap-6 py-16 md:flex-row md:py-17">
          <div className="flex flex-col items-start justify-center gap-4 self-stretch px-3 md:flex-row md:px-12">
            ...
            <div className="flex flex-1 flex-col items-start justify-start gap-6 overflow-hidden px-6 py-6 pt-0 pb-0 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] shadow-none">
              <div
                className="font-mont text-muted-foreground line-clamp-5 flex h-[200px] flex-col justify-start self-stretch overflow-hidden text-2xl leading-10 font-medium tracking-tight transition-all duration-700 ease-in-out md:h-[210px] md:text-[32px] md:leading-[42px]"
                style={{
              ...
              >
                <div className="font-mont flex flex-col justify-center self-stretch text-lg leading-[26px] font-medium text-[rgba(73,66,61,0.90)]">
                  {testimonials[activeTestimonial].name}
                </div>
                <div className="font-mont flex flex-col justify-center self-stretch text-lg leading-[26px] font-medium text-[rgba(73,66,61,0.70)]">
